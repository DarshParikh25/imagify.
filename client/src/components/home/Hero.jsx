const Hero = () => {
  return (
    <section
      id="hero"
      className="hero grid lg:grid-cols-2 grid-cols-1 text-white h-[75vh] font-secondary"
    >
      ...
      <div className="w-full relative">
        <div className="left-52 top-0 absolute -rotate-[10deg] w-[250px] h-[350px] bg-white flex justify-center items-center z-20">
          <img src="/first.jpg" alt="" className="w-[200px] h-[300px]" />
        </div>
        <div className="left-96 top-48 rotate-[20deg] absolute w-[250px] h-[350px] bg-white flex justify-center items-center z-30">
          <img src="/second.jpg" alt="" className="w-[200px] h-[300px]" />
        </div>
        <div className="left-14 top-52 -rotate-[25deg] absolute w-[250px] h-[350px] bg-white flex justify-center items-center z-10">
